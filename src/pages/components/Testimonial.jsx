        ...
        <div className='flex flex-wrap mt-10 lg:mt-20 items-center'>
          ...
          <div className='w-full lg:w-1/2 px-4'>
            ...
            <div className='flex' data-aos='fade-up'>
              <Image
                className='ms-0.5 duration-25 transition-all hover:opacity-100 hover:scale-100 w-10 h-10 mt-5'
              ...
              />
              <Image
                className='ms-0.5 duration-25 transition-all hover:opacity-100 scale-75  opacity-55 hover:scale-100 w-10 h-10 mt-5'
